...
\`\`\`
    ...
    const url = `https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash-lite:generateContent?key=${GEMINI_API_KEY}`;
    ...
    if (!data.candidates) {
        ...
        throw new Error(`Gemini API call failed: ${data.error?.message || 'Unknown error'}`);
    }

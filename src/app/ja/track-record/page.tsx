                ...
                <div className="lg:col-span-8 p-6 md:p-12 lg:p-16 space-y-20 border-r border-slate-100">
                    ...
                    <div className="space-y-8 max-w-2xl">
                        <div className="inline-flex items-center gap-2 px-3 py-1 bg-indigo-50 border border-indigo-100/50 rounded-none">
                            ...
                            <span className="text-[10px] font-black text-indigo-600 tracking-widest uppercase">誠実なPR・実績公開</span>
                        </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div className="bg-slate-50 border border-slate-100 p-6 rounded-none space-y-2">
                            <div className="text-[9px] font-black text-slate-400 uppercase tracking-widest leading-none">予測総数</div>
                        ...
                        <div className="bg-emerald-50 border border-emerald-100 p-6 rounded-none space-y-2">
                            <div className="text-[9px] font-black text-emerald-600 uppercase tracking-widest leading-none">的中 (HIT)</div>
                        ...
                        <div className="bg-indigo-50 border border-indigo-100 p-6 rounded-none space-y-2">
                            <div className="text-[9px] font-black text-indigo-600 uppercase tracking-widest leading-none">勝率</div>
                        ...
                        <div className="bg-slate-100 border border-slate-200 p-6 rounded-none space-y-2">
                            <div className="text-[9px] font-black text-slate-400 uppercase tracking-widest leading-none">判定中</div>
                                ...
                                <table className="w-full text-left border-collapse">
                                    <thead>
                                        <tr className="bg-slate-50 border-b border-slate-100">
                                            <th className="px-6 py-4 text-[9px] font-black text-slate-400 uppercase tracking-widest whitespace-nowrap">日付</th>
                                            <th className="px-6 py-4 text-[9px] font-black text-slate-400 uppercase tracking-widest whitespace-nowrap">銘柄</th>
                                            <th className="px-6 py-4 text-[9px] font-black text-slate-400 uppercase tracking-widest whitespace-nowrap">予想</th>
                                            <th className="px-6 py-4 text-[9px] font-black text-slate-400 uppercase tracking-widest whitespace-nowrap">結果</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                            ...
                                            <tr key={report.id} className="border-b border-slate-50 hover:bg-slate-50/50 transition-colors">
                                                ...
                                                <td className="px-6 py-4">
                                                    <span className={`text-[9px] font-black px-1.5 py-0.5 rounded-none tracking-widest uppercase ${report.prediction_direction === 'UP' ? 'bg-emerald-50 text-emerald-500' : 'bg-rose-50 text-rose-500'}`}>
                                                        {report.prediction_direction === 'UP' ? '上昇' : '下落'}
                                                    </span>
                                                </td>
                                                <td className="px-6 py-4">
                                                    <div className={`flex items-center gap-1.5 text-[9px] font-black tracking-widest uppercase ${report.result === 'HIT' ? 'text-emerald-500' : report.result === 'MISS' ? 'text-rose-500' : 'text-slate-300'}`}>
                                                        ...
                                                        {report.result === 'HIT' ? '成功' : report.result === 'MISS' ? '不的中' : '判定中'}
                                                    </div>
                                                </td>
                                            </tr>
                                        ))}

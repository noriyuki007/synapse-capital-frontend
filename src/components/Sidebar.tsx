    ...
    return (
        <aside className={`bg-white space-y-16 ${className}`}>
            <div className="space-y-10">
                            ...
                            <Link key={report.id} href={`/ja/reports/${report.id}`} className="block group">
                                <article className="space-y-4">
                                    <div className="flex items-center gap-4">
                                        <span className="text-[9px] font-black uppercase px-2 py-0.5 bg-white border border-slate-200 rounded-none text-slate-400 tracking-widest">
                ...
                <Link href="/ja/reports" className="w-full py-4 bg-white border border-slate-200 rounded-none text-[10px] font-black uppercase tracking-[0.3em] flex items-center justify-center gap-3 text-slate-500 hover:bg-black hover:text-white hover:border-black transition-all">
            ...
            <div className="p-10 bg-slate-50 border border-slate-100 rounded-none space-y-8 relative overflow-hidden group">
                ...
                <div className="text-[10px] font-black text-slate-400 uppercase tracking-widest relative z-10">グローバル分析実績</div>
